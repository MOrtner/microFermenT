...
A guided laboratory course for third year bioprocess engineering students was designed by lecturer Markus G. One experiment was the cultivation of *Lactobacillus lactis* in its wild-type strain and the recording of basic growth parameters such as pH, cell density or carbon source concentration. Due to a tight schedule and the slow growth of *L. lactis*, the main problem was the limited time available of only 6 hours.
...
To solve both problems, a 3D printable miniature bioreactor was developed by Martin Ortner, a PhD student at the Department of Biopolymer Chemistry. He worked closely with Markus G., who contributed the pedagogical aspects and *Vibrio natriegens*. Together with the switch from *Lactobacillus lactis* to the fast-growing *V. natriegens*, the 6 hour deadline was reachable.
